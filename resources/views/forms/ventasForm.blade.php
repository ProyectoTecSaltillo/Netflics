        ...
        <div class="row">
            <div class="col-12">
                <div class="p-20">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="{{ route('ventas.store') }}">
                        {{ csrf_field() }}
                        ...
                        <button type="submit" id="agregar" class="btn btn-default waves-effect waves-light pull-right">Agregar venta</button>
