...
<div class="row">
    <div class="col-sm-12">
        ...
        <p class="text-muted page-title-alt">Menú / Usuarios</p>
    </div>
</div>
    ...
    <div id="datatable_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-5">
                <div class="dataTables_info" id="datatable_info" role="status" aria-live="polite">Mostrando {{ $users->count() }} de 10 registros</div>
            </div>
